        ...
        , mForwardSpeed(forwardSpeed)
{
    ...
    mRigidBodyComponent->SetVelocity(mForwardSpeed * Vector2(1, 0));
    ...
    mDrawComponent = new DrawAnimatedComponent(this, "../Assets/Sprites/Goomba/SpriteSheetGoomba.png", "../Assets/Sprites/Goomba/SpriteSheetGoomba.json");
    //  - 2.3.1 (2 linha): Utilize a função `AddAnimation` para adicionar as animações "dead" e "walk".
    std::vector<int> walkAnimation = {1, 2};
    mDrawComponent->AddAnimation("walk", walkAnimation);
