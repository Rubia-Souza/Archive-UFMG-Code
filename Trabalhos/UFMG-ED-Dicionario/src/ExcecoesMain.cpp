...
ExcecoesMain::ArgumentoInvalidoException::ArgumentoInvalidoException(const std::string mensagem) : Excecao(mensagem) {}
ExcecoesMain::ArgumentoInvalidoException::~ArgumentoInvalidoException() {}

ExcecoesMain::TipoDicionarioNaoInformadoException::TipoDicionarioNaoInformadoException(const std::string mensagem) : Excecao(mensagem) {}
ExcecoesMain::TipoDicionarioNaoInformadoException::~TipoDicionarioNaoInformadoException() {}
