    ...
    def getToken(self):
        ...
        if tokenText == "\n":
            ...
            if tokenText == "true":
                ...
                token = Token(tokenText, TokenType.IFX)
            elif tokenText == "then":
                token = Token(tokenText, TokenType.THN)
            elif tokenText == "else":
                token = Token(tokenText, TokenType.ELS)
            elif tokenText == "and":
                token = Token(tokenText, TokenType.AND)
            elif tokenText == "or":
                token = Token(tokenText, TokenType.ORX)
            else:
